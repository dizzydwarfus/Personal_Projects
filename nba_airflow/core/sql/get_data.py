...
if os.path.isfile(r'D:\lianz\Desktop\Python\personal_projects\nba_airflow\data\games_played.csv'):
    read_df = pd.read_csv(
        r'D:\lianz\Desktop\Python\personal_projects\nba_airflow\data\games_played.csv', index_col=0)
...
df_final = pd.read_csv(r'D:\lianz\Desktop\Python\personal_projects\nba_airflow\data\games_played.csv',
...
if os.path.exists(r'D:\lianz\Desktop\Python\personal_projects\nba_airflow\data\play_by_play.parquet'):
